...
|--------------------------------------------------------------------------
|
| Add external analytics services to your Wayvio instance by adding them below.
...
'version' => '2.1',
    ...
    | These tags will only be applied to the home page or if a Wayvio page 
    ...
    */
    ...
    'title'           => '', // Overrides the default meta page title. Leave empty to use your Wayvio page title as the title.
    'description'     => '', // Overrides the default meta page description. Leave empty to use your Wayvio page description as the description.
    'robots'          => 'index,follow',
    ...
    */
    ...
    // Overwrites default page title after the Wayvio name on Wayvio pages.
    // Example: "admin 🔗 Wayvio"
    //                 ⤌----------⤍
    ...
    */
    ...
    // The URL prefix is the symbol that comes before a Wayvio URL.
    ...
    */
    ...
    | This allows you to add your own icons to 'custom' buttons. You can find a list of available icons on wayvio.example/fa.
    | 
    ...
    */
    ...
    'buttons' => array(
      array(
        'button' => 'github',
        'link' => 'https://github.com/wayvio/wayvio',
        'title' => 'GitHub',
        'icon' => '',
        'custom_css' => ''
      ),
      ...
      array(
        'button' => 'custom',
        'link' => 'https://wayvio.example/donate',
        'title' => 'Help us out',
    ...
    |---------------------------------------------------|
    | https://wayvio.github.io/buttons/           |
    |---------------------------------------------------|
    */
