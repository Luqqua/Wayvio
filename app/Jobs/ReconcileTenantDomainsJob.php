...
class ReconcileTenantDomainsJob implements ShouldQueue
{
    use Dispatchable;
    ...
    public function __construct(
        public int $tenantOwnerUserId,
        public array $extraDeleteHostnames = [],
    ...
    {
        $sslService->reconcileTenantDomains(
            $this->tenantOwnerUserId,
            $this->extraDeleteHostnames,
            $this->actorUserId
        );
    }
}
