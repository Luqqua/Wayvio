...
class ReportNewestCommand extends BaseModCommand
{
    protected $signature = 'report:newest {--page=1} {--status=all} {--user_id=} {--with-deleted}';
    protected $description = 'Meldungen nach Neuigkeit sortiert anzeigen.';
