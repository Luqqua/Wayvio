...
<div class="ls-profile-summary-core ls-profile-summary-core--business ls-profile-summary-core--title-focus {{ $insideHero ? 'ls-profile-summary-core--inside-hero' : '' }} fadein">
    <div class="ls-profile-summary-core__brand ls-profile-summary-core__brand--title-lockup {{ $showAvatar ? '' : 'ls-profile-summary-core__brand--no-avatar' }}">
        @if($showAvatar)
            <div class="ls-profile-summary-core__brand-mark">
                @include('wayvio.elements.avatar')
            </div>
        @endif
        <div class="ls-profile-summary-core__title ls-profile-summary-core__title--brand">
