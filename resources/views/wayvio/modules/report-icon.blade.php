@if(env('ENABLE_REPORT_ICON') == true)
@php
  $reportLabel = __('messages.report_short');
  if ($reportLabel === 'messages.report_short') {
    $reportLabel = __('messages.report_violation');
  }
@endphp
<style>
  ...
  <path d="m8.93 6.588-2.29.287-.082.38.45.083c.294.07.352.176.288.469l-.738 3.468c-.194.897.105 1.319.808 1.319.545 0 1.178-.252 1.465-.598l.088-.416c-.2.176-.492.246-.686.246-.275 0-.375-.193-.304-.533zM9 4.5a1 1 0 1 1-2 0 1 1 0 0 1 2 0"/>
    ...
    <div class="report-expanding-pill">
      <a href="{{ wayvioReportUrl((int) $userinfo->id) }}" target="_blank" class="report-text">{{ $reportLabel }}</a>
    </div>
  </div>
