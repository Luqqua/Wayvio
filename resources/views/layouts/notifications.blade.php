    ...
    @php
        $notifications = [
            ...
            [
                ...
                'title' => __('messages.Enjoying Wayvio?'),
...
notification('', 'modal-1', __('messages.Your security is at risk!'), '<b>'.__('messages.security.msg1').'</b> '.__('messages.security.msg2').'<br><br>'.__('messages.security.msg3').'<br><span>'.__('messages.security.msg3').' (siehe Konfigurationsdatei)</span>.');
notification('hide-star-notification', 'modal-star', __('messages.Support Wayvio'), ''.__('messages.support.msg1').' <a target="_blank" href="https://github.com/wayvio/wayvio">'.__('messages.support.msg2').'</a>. '.__('messages.support.msg3').'<br><br>'.__('messages.support.msg4').' <a target="_blank" href="https://wayvio.example/donate">'.__('messages.support.msg5').'<br><br>'.__('messages.support.msg6').'');
@endphp @endpush
