...
if (env('APP_NAME') == 'LittleLink Custom' or env('APP_NAME') == 'LittleLink') {
    EnvEditor::editKey('APP_NAME', 'Wayvio');
}
...
if (strpos($data['page']->contact, 'info@littlelink-custom.com') !== false or strpos($data['page']->contact, 'LittleLink Custom') !== false) {
    $contact = '
            <p><strong><a href="https://wayvio.example/">Wayvio</a></strong> is a free, open source&nbsp;link&nbsp;sharing platform. We depend on community feedback to steadily improve this project.</p>
            
            <p><strong>Feel free to send us your feedback!</strong></p>
            
            <ul>
            	<li>Join the <a href="https://github.com/wayvio/wayvio/discussions">discussion forum</a></li>
            	<li>Request a feature and add it to the <a href="https://github.com/wayvio/wayvio/discussions/49">to-do list</a></li>
            	<li>Write us an <a href="mailto:info@wayvio.example?subject=Inquiry%20about%20Wayvio">email</a></li>
            </ul>
            
            <p>If you&#39;re having any trouble or encountered a bug, feel free to <a href="https://github.com/wayvio/wayvio/issues">open an issue on GitHub</a>.</p>
...
try {
    if (is_dir(base_path('littlelink/images'))) {
        ...
        foreach ($files as $file) {
            $filename = $file->getFilename();
            $destination = base_path('assets/wayvio/images/' . $filename);
            if (!File::exists($destination)) {
                if (!$file->isDir()) {
                    File::move($file, $destination);
                }
