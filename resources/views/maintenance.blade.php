...
<link rel="stylesheet" href="{{ asset('assets/external-dependencies/fontawesome.css') }}" />
  ...
  <link rel="stylesheet" href="{{ asset('assets/wayvio/css/normalize.css') }}">
  ...
  <link rel="stylesheet" href="{{ asset('assets/wayvio/css/skeleton-dark.css') }}">
  @elseif ($color_scheme_override == 'light')
  <link rel="stylesheet" href="{{ asset('assets/wayvio/css/skeleton-light.css') }}">
  ...
  <style>@font-face{font-family:'ll';src:url({{ asset('assets/wayvio/fonts/littlelink-custom.otf') }}) format("opentype")}</style>
...
<div class="containerr" style="">
      <div class="column">
        ...
        <img alt="avatar" src="{{ asset('assets/wayvio/images/'.findFile('avatar')) }}" width="auto" height="200px">
        @else
        <div class="logo-container">
           <img src="{{ asset('assets/wayvio/images/logo.svg') }}" alt="Logo" style="width:200px; height:200px;">
        </div>
        @endif
