...
<head>
  <!-- begin dark mode detection -->
	<script src="{{ asset('assets/wayvio/js/js.cookie.min.js') }}"></script>
	<script>
...
<body>
    <div id='zPHP'>
<div style="position: relative; top: 50px; z-index: 2;"><a href="{{ url('dashboard') }}" style="font-size: 40px;" >&nbsp; &nbsp; &nbsp; Back</a></div>
