        ...
        <div style="max-width:480px" class="container mt-5 w-100">
          <div class="card p-5">
              ...
              <form method="POST" action="{{ route('password.update') }}">
                ...
                <input type="hidden" name="reset_context" value="{{ old('reset_context', $resetContext) }}">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" value="{{ $resetEmail }}" readonly disabled>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input id="password" class="form-control" type="password" name="password" minlength="10" placeholder="{{ __('messages.Password must be at least 10 characters with uppercase and a number') }}" required>
                        </div>
                    </div>
