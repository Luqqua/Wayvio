          ...
          <div class="card p-5">
              ...
              <form method="POST" action="{{ route('login') }}">
                ...
                <div class="row">
                  ...
                  @include('auth.partials.captcha', ['context' => \App\Services\Security\CaptchaVerifier::CONTEXT_LOGIN])
                ...
                <br>
                @endif
                @if (config('auth.allow_registration') && !config('linkstack.single_user_mode'))
