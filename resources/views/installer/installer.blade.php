...
@else
        ...
        <h1>{{__('messages.Setup Wayvio')}}</h1>
        <p class="inst-txt">
        <div class="left-txt glass-container">
         {{__('messages.Welcome to the setup for Wayvio!')}}<br><br>
...
<p style="margin:25px;max-width:350px;">{{__('messages.setup.disclaimer')}} <a href="https://wayvio.example/terms-and-conditions/" target="_blank">{{__('messages.Terms and Conditions')}}</a>.</p>
...
<input style="max-width:275px;" class="form-control" value="Wayvio" name="app" type="text" required>
