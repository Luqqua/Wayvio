...
(function () {
    ...
    const updateMode = () => {
        ...
        const sidebarDefaultEl = document.querySelector('.sidebar-default');
        const navbarEl = document.querySelector('.iq-navbar');
        // Continue gracefully even if some elements are missing
        ...
        if(allActiveType !== null && allActiveType !== undefined && sidebarEl) {
            sidebarEl.classList.remove('navs-rounded-all')
            sidebarEl.classList.add(`${allActiveType}`)
        ...
        if(allNavbarType !== null && allNavbarType !== undefined && navbarEl){
            if(allNavbarType == 'nav-glass' || allNavbarType == 'navs-sticky' || allNavbarType == 'navs-transparent'){
                navbarEl.classList.add(`${allNavbarType}`)
            }
            if(allNavbarType == 'navs-bg-color'){
                navbarEl.classList.remove('nav-glass','navs-sticky','navs-transparent')
                const header = document.querySelector('.iq-navbar-header');
                if (header) { header.classList.add(`${allNavbarType}`) }
            }
