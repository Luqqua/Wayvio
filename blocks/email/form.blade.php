...
<input type='email' name='link' value='{{str_replace("mailto:", "", $link)}}' class='form-control' required autocomplete='off' autocapitalize='off' autocorrect='off' spellcheck='false' inputmode='email' data-lpignore='true' data-1p-ignore='true' />
