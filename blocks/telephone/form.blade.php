...
<input type='tel' name='link' value='{{str_replace("tel:", "", $link)}}' class='form-control' required autocomplete='off' autocapitalize='off' autocorrect='off' spellcheck='false' inputmode='tel' data-lpignore='true' data-1p-ignore='true' />
